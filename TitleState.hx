	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 9:
					#if PSYCH_WATERMARKS
					addMoreText('George08091', 15);
					addMoreText('Kaixvny/Kai.', 15);
					addMoreText('Roborg8', 15);
					addMoreText('Azzy/Boodaisy ', 15);
					addMoreText('RealDealMaks', 15);
					addMoreText('Monster Pog', 15);
					addMoreText('present...');
					#end
					case 10:
						deleteCoolText();
				...
				case 17:
			    	addMoreText('Ping'); // credTextShit.text += '\nFunkin';
				case 18:
