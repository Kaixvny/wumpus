...
class Achievements {
	public static var achievementShits:Array<Dynamic> = [//Name, Description, Achievement save tag, Unlocks after, Hidden achievement
		...
		["Ping-Pong!",					"Beat \"Wumpus\" Song!",	'wum1',				null,			false],
		["Free Nitro!",					"Beat \"Nitro\" Song!",	'nitro1',				null,			false],
		["Galactic Mayhem!",					"Beat \"Boost\" Song!",	'boost1',				null,			false],
		["Wumpus Mayhem!!!",					"Beat \"Wumpus\" Song on @everyone!",	'wum2',				null,			false],
		["Round and Round!",					"Beat \"Nitro\" Song on @everyone!",	'nitro2',				null,			false],
		["Cosmic King!",					"Beat \"Boost\" Song on @everyone!",	'boost2',				null,			false],
